...
export default function ContactPage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section
        className="relative bg-cover bg-center text-white min-h-[50vh] sm:min-h-[60vh] flex items-center justify-center"
        style={{
      ...
      >
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-5xl font-[heading-1] mb-4 text-white">
            Contact Us
          </h1>
