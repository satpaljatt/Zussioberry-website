...
/**
 * ============================================================================
 * HEADER / NAVBAR COMPONENT (FRAPPÉ THEME UPGRADE)
 * ============================================================================
 * Benchmark: Frappé – A Smoothie & Organic Juice Bar Theme (Qode Interactive)
 * Reference: https://frappe.qodeinteractive.com/
 * 
 * ARCHITECTURE BREAKDOWN:
 * 1. Single-Row Editorial Layout:
 *    - Left: Brand Logo (Zussioberry)
 *    - Center: Main navigation with cursor-following dotted indicator (.eltdf-active-item)
 *    - Right: "Get Franchise" primary CTA button
 * 2. Cursor-Following Bottom Dotted Animation:
 *    - Dotted line glides along the bottom baseline following cursor in real-time
 *    - Glides smoothly back to active page when mouse leaves the navbar
 * 3. Organic Torn-Paper Cut-Off Wave Effect:
 *    - Exact SVG wave path rendered at bottom edge to frame the header
 * 4. Token-Driven Styling:
 *    - Text Color: #5a5a5a (primary), #8f8f8f (secondary), #23aa5d (active/hover)
 *    - Typography: Open Sans / Quicksand 15px with letter-spacing
 * ============================================================================
 */
...
// Primary Navigation Links (Center Nav)
const navLinks = [
...
const productsPopupLinks = [
  ...
  { href: '/frozen-treats', label: 'Frozen Treats' },
];
...
const Navbar = () => {
  ...
  const emailAddress = 'franchise@zussioberry.com';
  ...
  // Sticky Scroll Listener (Smooth transition after 80px scroll)
  useEffect(() => {
    const handleScroll = () => {
  ...
  // Dropdown animation variants (Frappé spring reveal)
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
          <div className="flex items-center justify-between h-[65px] sm:h-[75px] lg:h-[95px]">
            ...
            <div className="flex-shrink-0 flex items-center">
              <Link href="/" className="inline-block relative transition-transform duration-200 hover:scale-[1.02]">
                <Image
                  src="/assets/zlogo1.png"
                  alt="Zussioberry - Blended with Delight"
                  width={150}
                  height={55}
                  priority
            ...
            <nav className="hidden md:flex items-center space-x-3.5 md:space-x-4 lg:space-x-6 xl:space-x-8">
                ...
                <AnimatePresence>
                  {aboutDropdownOpen && (
                    <motion.div
                      ...
                      animate="visible"
                      exit="exit"
                      className="absolute left-0 top-full mt-2 w-48 bg-white border border-[#eaeaea] rounded-[5px] shadow-[0_10px_30px_rgba(0,0,0,0.08)] py-2 z-50"
                    >
                      {aboutPopupLinks.map(link => (
                        <Link
                          key={link.href}
                          href={link.href}
              ...
              {navLinks.map(item => (
                <div
                  key={item.href}
                  className="relative py-2 flex items-center group cursor-pointer"
                >
                  <Link
                    href={item.href}
        ...
        {/* -------------------------------------------------------------------- */}
        {/* 6. BOTTOM ORGANIC CUT-OFF WAVE SVG (Exact Frappé Theme Divider)       */}
        {/* -------------------------------------------------------------------- */}
        ...
        {isOpen && (
          <>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center justify-between pb-6 border-b border-[#eaeaea]">
                  ...
                  <button
                    type="button"
                    onClick={handleCloseMenu}
                    className="p-2 text-[#5a5a5a] hover:text-[#23aa5d] rounded-full hover:bg-gray-100 transition-colors"
                  >
                    <X size={22} />
                  </button>
                </div>
                ...
                <div className="py-6 space-y-4">
                  ...
                  <div className="py-1">
                    ...
                    {aboutDropdownOpen && (
                      <div className="pl-4 py-2 space-y-2 border-l-2 border-[#23aa5d]/30 ml-2">
                        {aboutPopupLinks.map(link => (
                          <Link
                            key={link.href}
                            href={link.href}
              ...
              <div className="p-6 bg-[#fbfaf7] border-t border-[#eaeaea] space-y-4">
                <button
                  type="button"
                  onClick={() => {
                    handleCloseMenu();
                  ...
                  className="w-full bg-[#23aa5d] hover:bg-[#1e9652] text-white py-3 rounded-[5px] text-[15px] font-semibold tracking-wider shadow-md transition-all text-center cursor-pointer"
                >
                  Get Franchise
                </button>

                <div className="pt-2 space-y-2 text-[13px] text-[#8f8f8f]">
                  <div
                    onClick={handleCall}
                    className="flex items-center gap-2 cursor-pointer hover:text-[#23aa5d] transition-colors"
                  >
                    <Phone size={14} className="text-[#23aa5d]" />
                  ...
                  <div
                    ...
                    className="flex items-center gap-2 cursor-pointer hover:text-[#23aa5d] transition-colors"
                  >
                    <Mail size={14} className="text-[#23aa5d]" />
